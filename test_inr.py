...
data = {
    "message": "Show me flights from Delhi to Mumbai on 15th October",
    "session_id": "test_inr_session"
}

print("Testing currency conversion to INR...")
...
try:
    ...
    if response.status_code == 200:
        ...
        if result.get('flight_data'):
            ...
            print("\nFirst 3 flights with prices in INR:")
            print("-" * 50)
